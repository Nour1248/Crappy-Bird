...
{
  //////////////////////////////////////////////////////////////////////////////////////////
  sf::RenderWindow window (sf::VideoMode (WIDTH, HEIGHT), "Crappy Bird",
  ...
  fb::pipe::create_upper_pipes (upper_pipes,
                                "assets/sprites/pipe-green-reversed.png");
...
// pipes[0]->set_position(sf::Vector2f(pipes[0]->get_sprite().getGlobalBounds().left
// - 1, pipes[0]->get_sprite().getGlobalBounds().top));